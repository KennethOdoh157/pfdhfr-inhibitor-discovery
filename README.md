...
Pyrimethamine-resistant *Plasmodium falciparum* remains one of the most urgent problems in antimalarial drug discovery. The K1 strain carries four resistance mutations in dihydrofolate reductase (N51I/C59R/S108N/I164L) that have rendered the clinical antifolate pyrimethamine essentially useless across sub-Saharan Africa, yet the chemical space of African medicinal plants has never been systematically evaluated against this resistant target by computational methods.

This project builds a complete, end-to-end computational pipeline that starts from 695,133 natural product structures in the COCONUT database and works through QSAR modeling, multi-stage virtual screening, molecular docking, and 100 ns molecular dynamics simulations to identify African-origin compounds capable of engaging the resistant PfDHFR binding pocket. The best hit, CNP0286261, achieved a predicted binding affinity of -11.86 kcal/mol compared to -6.90 kcal/mol for pyrimethamine. All ten top-ranked docking hits came from African natural products (Mann-Whitney p = 0.0049), and molecular dynamics confirmed that two of the three shortlisted hits maintain stable, hydrogen bond-anchored binding to the resistant active site over the full 100 ns trajectory.

Three peer-reviewed manuscripts are in preparation from this single integrated pipeline.
...
> - **Best hit at -11.86 kcal/mol**, representing a 4.96 kcal/mol advantage over pyrimethamine
...
> - Three manuscripts targeting Q1/Q2 computational chemistry journals
...
1. Can African natural product chemical space yield competitive PfDHFR inhibitors, even though it diverges structurally from the synthetic antifolates that dominate ChEMBL training data?
2. Does QSAR-predicted probability of activity correlate with docking-predicted binding affinity for natural products with low structural similarity to known inhibitors?
...
*Figure 11. Distribution of AutoDock Vina docking scores for African NPs vs global NPs. African NPs show a statistically significant shift toward stronger predicted binding (Mann-Whitney p = 0.0049).*
...
CNP0539885 formed a persistent electrostatic anchor to ASP54 at 94.2% occupancy, dramatically outperforming pyrimethamine's top interaction (31.7%). This residue is conserved in the resistant active site and is a key pharmacophoric contact for antifolate binding.
...
CNP0286261 showed a more dynamic binding mode (ligand RMSD 9.19 A) but made direct contact with the ASN51 resistance mutation site at 73% frequency, which may be mechanistically relevant for overcoming resistance.
...
|-------|---------|---------------|--------|
| Paper 1 | QSAR model development, applicability domain analysis, chemical space characterisation of African NPs, NPASS prospective recall | Journal of Cheminformatics (Q1) | In preparation |
| Paper 2 | Virtual screening cascade, molecular docking against resistant PfDHFR, statistical comparison of African vs global NPs | Computational Biology and Chemistry (Q2) | In preparation |
| Paper 3 | 100 ns molecular dynamics, binding stability analysis, hydrogen bond networks, resistance mutation contacts | Journal of Biomolecular Structure and Dynamics (Q1) | In preparation |
...
Department of Chemistry, Air Force Institute of Technology (AFIT), Kaduna, Nigeria

B.Sc. Chemistry (First Class Honours), AFIT Kaduna. Best Graduating Student, Department of Chemistry and Faculty of Science.
...
*All software used in this project is open-source. Molecular dynamics compute resources were provided by Google Colab Pro. This pipeline was developed as an independent research project targeting peer-reviewed publication in computational drug discovery.*
